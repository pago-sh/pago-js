...
export interface PagoOptions extends Omit<ClientOptions, "version"> {
  version?: string;
}

export function createPago(options: PagoOptions) {
...
export type Pago = ReturnType<typeof createPago>;
