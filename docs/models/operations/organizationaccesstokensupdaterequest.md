...
```typescript
import { OrganizationAccessTokensUpdateRequest } from "@pago-sh/sdk/models/operations/organizationaccesstokensupdate.js";

let value: OrganizationAccessTokensUpdateRequest = {
  id: "<value>",
