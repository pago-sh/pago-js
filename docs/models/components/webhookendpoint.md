...
```typescript
import { WebhookEndpoint } from "@pago-sh/sdk/models/components/webhookendpoint.js";
...
let value: WebhookEndpoint = {
  ...
  format: "discord",
  secret: "pago_whs_ovyN6cPrTv56AApvzCaJno08SSmGJmgbWilb33N2JuK",
...
| `secret`                                                                                      | *string*                                                                                      | :heavy_check_mark:                                                                            | The secret used to sign the webhook events.                                                   | pago_whs_ovyN6cPrTv56AApvzCaJno08SSmGJmgbWilb33N2JuK                                         |
