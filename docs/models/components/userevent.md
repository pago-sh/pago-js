...
```typescript
import { UserEvent } from "@pago-sh/sdk/models/components/userevent.js";
...
| `source`                                                                                                                       | *"user"*                                                                                                                       | :heavy_check_mark:                                                                                                             | The source of the event. `system` events are created by Pago. `user` events are the one you create through our ingestion API. |                                                                                                                                |
