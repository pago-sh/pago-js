...
```typescript
import { SubscriptionBillingPeriodUpdatedEvent } from "@pago-sh/sdk/models/components/subscriptionbillingperiodupdatedevent.js";
...
| `customerId`                                                                                                                   | *string*                                                                                                                       | :heavy_check_mark:                                                                                                             | ID of the customer in your Pago organization associated with the event.                                                       |                                                                                                                                |
...
| `source`                                                                                                                       | *"system"*                                                                                                                     | :heavy_check_mark:                                                                                                             | The source of the event. `system` events are created by Pago. `user` events are the one you create through our ingestion API. |                                                                                                                                |
