...
async function run() {
  const result = await pago.checkouts.list({
...
import { checkoutsList } from "@pago-sh/sdk/funcs/checkoutsList.js";
...
async function run() {
  const res = await checkoutsList(pago, {
    organizationId: "1dbfc517-0bbf-4301-9ba8-555ca42b9737",
  });
  if (res.ok) {
...
```typescript
import { PagoCore } from "@pago-sh/sdk/core.js";
import { checkoutsCreate } from "@pago-sh/sdk/funcs/checkoutsCreate.js";
...
async function run() {
  const res = await checkoutsCreate(pago, {
    customerName: "John Doe",
    customerBillingAddress: {
      country: "US",
    },
...
async function run() {
  const result = await pago.checkouts.get({
    id: "<value>",
  });
...
```typescript
import { PagoCore } from "@pago-sh/sdk/core.js";
import { checkoutsGet } from "@pago-sh/sdk/funcs/checkoutsGet.js";
...
async function run() {
  const res = await checkoutsGet(pago, {
    id: "<value>",
  });
  if (res.ok) {
    const { value: result } = res;
...
async function run() {
  const result = await pago.checkouts.update({
    id: "<value>",
    checkoutUpdate: {
      customerName: "John Doe",
      customerBillingAddress: {
...
```typescript
import { PagoCore } from "@pago-sh/sdk/core.js";
import { checkoutsUpdate } from "@pago-sh/sdk/funcs/checkoutsUpdate.js";
...
async function run() {
  const res = await checkoutsUpdate(pago, {
    id: "<value>",
    checkoutUpdate: {
      customerName: "John Doe",
      customerBillingAddress: {
...
async function run() {
  const result = await pago.checkouts.clientGet({
    clientSecret: "<value>",
  });
...
```typescript
import { PagoCore } from "@pago-sh/sdk/core.js";
import { checkoutsClientGet } from "@pago-sh/sdk/funcs/checkoutsClientGet.js";
...
async function run() {
  const res = await checkoutsClientGet(pago, {
    clientSecret: "<value>",
  });
  if (res.ok) {
    const { value: result } = res;
...
async function run() {
  const result = await pago.checkouts.clientUpdate({
    clientSecret: "<value>",
...
```typescript
import { PagoCore } from "@pago-sh/sdk/core.js";
import { checkoutsClientUpdate } from "@pago-sh/sdk/funcs/checkoutsClientUpdate.js";
...
async function run() {
  const res = await checkoutsClientUpdate(pago, {
    clientSecret: "<value>",
    checkoutUpdatePublic: {
      customerName: "John Doe",
      customerBillingAddress: {
...
async function run() {
  const result = await pago.checkouts.clientConfirm({
    clientSecret: "<value>",
...
```typescript
import { PagoCore } from "@pago-sh/sdk/core.js";
import { checkoutsClientConfirm } from "@pago-sh/sdk/funcs/checkoutsClientConfirm.js";
...
async function run() {
  const res = await checkoutsClientConfirm(pago, {
    clientSecret: "<value>",
    checkoutConfirmStripe: {
      customerName: "John Doe",
      customerBillingAddress: {
