...
async function run() {
  const result = await pago.customers.list({
...
import { customersList } from "@pago-sh/sdk/funcs/customersList.js";
...
async function run() {
  const res = await customersList(pago, {
    organizationId: "1dbfc517-0bbf-4301-9ba8-555ca42b9737",
  });
  if (res.ok) {
...
async function run() {
  const result = await pago.customers.create({
    externalId: "usr_1337",
    name: "John Doe",
    billingAddress: {
      country: "US",
...
```typescript
import { PagoCore } from "@pago-sh/sdk/core.js";
import { customersCreate } from "@pago-sh/sdk/funcs/customersCreate.js";
...
async function run() {
  const res = await customersCreate(pago, {
    externalId: "usr_1337",
    name: "John Doe",
    billingAddress: {
      country: "US",
...
async function run() {
  const result = await pago.customers.export({
    organizationId: "1dbfc517-0bbf-4301-9ba8-555ca42b9737",
  });
...
```typescript
import { PagoCore } from "@pago-sh/sdk/core.js";
import { customersExport } from "@pago-sh/sdk/funcs/customersExport.js";
...
async function run() {
  const res = await customersExport(pago, {
    organizationId: "1dbfc517-0bbf-4301-9ba8-555ca42b9737",
  });
  if (res.ok) {
    const { value: result } = res;
...
async function run() {
  const result = await pago.customers.get({
    id: "<value>",
  });
...
```typescript
import { PagoCore } from "@pago-sh/sdk/core.js";
import { customersGet } from "@pago-sh/sdk/funcs/customersGet.js";
...
async function run() {
  const res = await customersGet(pago, {
    id: "<value>",
  });
  if (res.ok) {
    const { value: result } = res;
...
```typescript
import { PagoCore } from "@pago-sh/sdk/core.js";
import { customersDelete } from "@pago-sh/sdk/funcs/customersDelete.js";
...
async function run() {
  const res = await customersDelete(pago, {
    id: "<value>",
  });
  if (res.ok) {
    const { value: result } = res;
...
async function run() {
  const result = await pago.customers.update({
    id: "<value>",
    customerUpdate: {
      email: "customer@example.com",
      name: "John Doe",
...
```typescript
import { PagoCore } from "@pago-sh/sdk/core.js";
import { customersUpdate } from "@pago-sh/sdk/funcs/customersUpdate.js";
...
async function run() {
  const res = await customersUpdate(pago, {
    id: "<value>",
    customerUpdate: {
      email: "customer@example.com",
      name: "John Doe",
...
async function run() {
  const result = await pago.customers.getExternal({
    externalId: "<id>",
  });
...
```typescript
import { PagoCore } from "@pago-sh/sdk/core.js";
import { customersGetExternal } from "@pago-sh/sdk/funcs/customersGetExternal.js";
...
async function run() {
  const res = await customersGetExternal(pago, {
    externalId: "<id>",
  });
  if (res.ok) {
    const { value: result } = res;
...
async function run() {
  await pago.customers.deleteExternal({
    externalId: "<id>",
  });
...
```typescript
import { PagoCore } from "@pago-sh/sdk/core.js";
import { customersDeleteExternal } from "@pago-sh/sdk/funcs/customersDeleteExternal.js";
...
async function run() {
  const res = await customersDeleteExternal(pago, {
    externalId: "<id>",
  });
  if (res.ok) {
    const { value: result } = res;
...
async function run() {
  const result = await pago.customers.updateExternal({
    externalId: "<id>",
...
```typescript
import { PagoCore } from "@pago-sh/sdk/core.js";
import { customersUpdateExternal } from "@pago-sh/sdk/funcs/customersUpdateExternal.js";
...
async function run() {
  const res = await customersUpdateExternal(pago, {
    externalId: "<id>",
    customerUpdateExternalID: {
      email: "customer@example.com",
      name: "John Doe",
...
async function run() {
  const result = await pago.customers.getState({
    id: "<value>",
  });
...
```typescript
import { PagoCore } from "@pago-sh/sdk/core.js";
import { customersGetState } from "@pago-sh/sdk/funcs/customersGetState.js";
...
async function run() {
  const res = await customersGetState(pago, {
    id: "<value>",
  });
  if (res.ok) {
    const { value: result } = res;
...
async function run() {
  const result = await pago.customers.getStateExternal({
    externalId: "<id>",
  });
...
```typescript
import { PagoCore } from "@pago-sh/sdk/core.js";
import { customersGetStateExternal } from "@pago-sh/sdk/funcs/customersGetStateExternal.js";
...
async function run() {
  const res = await customersGetStateExternal(pago, {
    externalId: "<id>",
  });
  if (res.ok) {
    const { value: result } = res;
...
async function run() {
  const result = await pago.customers.listPaymentMethods({
    id: "<value>",
  });
...
```typescript
import { PagoCore } from "@pago-sh/sdk/core.js";
import { customersListPaymentMethods } from "@pago-sh/sdk/funcs/customersListPaymentMethods.js";
...
async function run() {
  const res = await customersListPaymentMethods(pago, {
    id: "<value>",
  });
  if (res.ok) {
    const { value: result } = res;
...
async function run() {
  const result = await pago.customers.listPaymentMethodsExternal({
    externalId: "<id>",
  });
...
```typescript
import { PagoCore } from "@pago-sh/sdk/core.js";
import { customersListPaymentMethodsExternal } from "@pago-sh/sdk/funcs/customersListPaymentMethodsExternal.js";
...
async function run() {
  const res = await customersListPaymentMethodsExternal(pago, {
    externalId: "<id>",
  });
  if (res.ok) {
    const { value: result } = res;
