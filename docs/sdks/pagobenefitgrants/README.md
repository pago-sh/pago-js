...
import { customerPortalBenefitGrantsList } from "@pago-sh/sdk/funcs/customerPortalBenefitGrantsList.js";
...
async function run() {
  const res = await customerPortalBenefitGrantsList(pago, {
    customerSession: process.env["PAGO_CUSTOMER_SESSION"] ?? "",
  }, {});
  if (res.ok) {
...
async function run() {
  const result = await pago.customerPortal.benefitGrants.get({
    customerSession: process.env["PAGO_CUSTOMER_SESSION"] ?? "",
  }, {
    id: "<value>",
  });
...
```typescript
import { PagoCore } from "@pago-sh/sdk/core.js";
import { customerPortalBenefitGrantsGet } from "@pago-sh/sdk/funcs/customerPortalBenefitGrantsGet.js";
...
async function run() {
  const res = await customerPortalBenefitGrantsGet(pago, {
    customerSession: process.env["PAGO_CUSTOMER_SESSION"] ?? "",
  }, {
    id: "<value>",
  });
...
async function run() {
  const result = await pago.customerPortal.benefitGrants.update({
    customerSession: process.env["PAGO_CUSTOMER_SESSION"] ?? "",
  }, {
    id: "<value>",
...
```typescript
import { PagoCore } from "@pago-sh/sdk/core.js";
import { customerPortalBenefitGrantsUpdate } from "@pago-sh/sdk/funcs/customerPortalBenefitGrantsUpdate.js";
...
async function run() {
  const res = await customerPortalBenefitGrantsUpdate(pago, {
    customerSession: process.env["PAGO_CUSTOMER_SESSION"] ?? "",
  }, {
    id: "<value>",
    customerBenefitGrantUpdate: {
