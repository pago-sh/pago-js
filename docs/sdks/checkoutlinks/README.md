...
async function run() {
  const result = await pago.checkoutLinks.list({
...
import { checkoutLinksList } from "@pago-sh/sdk/funcs/checkoutLinksList.js";
...
async function run() {
  const res = await checkoutLinksList(pago, {
    organizationId: "1dbfc517-0bbf-4301-9ba8-555ca42b9737",
  });
  if (res.ok) {
...
async function run() {
  const result = await pago.checkoutLinks.create({
...
```typescript
import { PagoCore } from "@pago-sh/sdk/core.js";
import { checkoutLinksCreate } from "@pago-sh/sdk/funcs/checkoutLinksCreate.js";
...
async function run() {
  const res = await checkoutLinksCreate(pago, {
    paymentProcessor: "stripe",
    allowDiscountCodes: true,
    requireBillingAddress: false,
    productPriceId: "<value>",
...
async function run() {
  const result = await pago.checkoutLinks.get({
    id: "<value>",
  });
...
```typescript
import { PagoCore } from "@pago-sh/sdk/core.js";
import { checkoutLinksGet } from "@pago-sh/sdk/funcs/checkoutLinksGet.js";
...
async function run() {
  const res = await checkoutLinksGet(pago, {
    id: "<value>",
  });
  if (res.ok) {
    const { value: result } = res;
...
async function run() {
  await pago.checkoutLinks.delete({
    id: "<value>",
  });
...
```typescript
import { PagoCore } from "@pago-sh/sdk/core.js";
import { checkoutLinksDelete } from "@pago-sh/sdk/funcs/checkoutLinksDelete.js";
...
async function run() {
  const res = await checkoutLinksDelete(pago, {
    id: "<value>",
  });
  if (res.ok) {
    const { value: result } = res;
...
async function run() {
  const result = await pago.checkoutLinks.update({
    id: "<value>",
    checkoutLinkUpdate: {},
  });
...
```typescript
import { PagoCore } from "@pago-sh/sdk/core.js";
import { checkoutLinksUpdate } from "@pago-sh/sdk/funcs/checkoutLinksUpdate.js";
...
async function run() {
  const res = await checkoutLinksUpdate(pago, {
    id: "<value>",
    checkoutLinkUpdate: {},
  });
  if (res.ok) {
