...
async function run() {
  const result = await pago.oauth2.authorize();
...
import { oauth2Authorize } from "@pago-sh/sdk/funcs/oauth2Authorize.js";
...
async function run() {
  const res = await oauth2Authorize(pago);
  if (res.ok) {
...
async function run() {
  const result = await pago.oauth2.token({
...
```typescript
import { PagoCore } from "@pago-sh/sdk/core.js";
import { oauth2Token } from "@pago-sh/sdk/funcs/oauth2Token.js";
...
async function run() {
  const res = await oauth2Token(pago, {
    grantType: "authorization_code",
    clientId: "<id>",
    clientSecret: "<value>",
    code: "<value>",
...
async function run() {
  const result = await pago.oauth2.revoke({
    token: "<value>",
    clientId: "<id>",
    clientSecret: "<value>",
  });
...
```typescript
import { PagoCore } from "@pago-sh/sdk/core.js";
import { oauth2Revoke } from "@pago-sh/sdk/funcs/oauth2Revoke.js";
...
async function run() {
  const res = await oauth2Revoke(pago, {
    token: "<value>",
    clientId: "<id>",
    clientSecret: "<value>",
  });
...
async function run() {
  const result = await pago.oauth2.introspect({
    token: "<value>",
    clientId: "<id>",
    clientSecret: "<value>",
  });
...
```typescript
import { PagoCore } from "@pago-sh/sdk/core.js";
import { oauth2Introspect } from "@pago-sh/sdk/funcs/oauth2Introspect.js";
...
async function run() {
  const res = await oauth2Introspect(pago, {
    token: "<value>",
    clientId: "<id>",
    clientSecret: "<value>",
  });
...
async function run() {
  const result = await pago.oauth2.userinfo();
...
```typescript
import { PagoCore } from "@pago-sh/sdk/core.js";
import { oauth2Userinfo } from "@pago-sh/sdk/funcs/oauth2Userinfo.js";
...
async function run() {
  const res = await oauth2Userinfo(pago);
  if (res.ok) {
    const { value: result } = res;
    console.log(result);
  } else {
