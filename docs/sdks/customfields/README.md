...
async function run() {
  const result = await pago.customFields.list({
...
import { customFieldsList } from "@pago-sh/sdk/funcs/customFieldsList.js";
...
async function run() {
  const res = await customFieldsList(pago, {
    organizationId: "1dbfc517-0bbf-4301-9ba8-555ca42b9737",
  });
  if (res.ok) {
...
async function run() {
  const result = await pago.customFields.create({
    type: "select",
    slug: "<value>",
    name: "<value>",
    organizationId: "1dbfc517-0bbf-4301-9ba8-555ca42b9737",
...
```typescript
import { PagoCore } from "@pago-sh/sdk/core.js";
import { customFieldsCreate } from "@pago-sh/sdk/funcs/customFieldsCreate.js";
...
async function run() {
  const res = await customFieldsCreate(pago, {
    type: "select",
    slug: "<value>",
    name: "<value>",
    organizationId: "1dbfc517-0bbf-4301-9ba8-555ca42b9737",
...
async function run() {
  const result = await pago.customFields.get({
    id: "<value>",
  });
...
```typescript
import { PagoCore } from "@pago-sh/sdk/core.js";
import { customFieldsGet } from "@pago-sh/sdk/funcs/customFieldsGet.js";
...
async function run() {
  const res = await customFieldsGet(pago, {
    id: "<value>",
  });
  if (res.ok) {
    const { value: result } = res;
...
async function run() {
  await pago.customFields.delete({
    id: "<value>",
  });
...
```typescript
import { PagoCore } from "@pago-sh/sdk/core.js";
import { customFieldsDelete } from "@pago-sh/sdk/funcs/customFieldsDelete.js";
...
async function run() {
  const res = await customFieldsDelete(pago, {
    id: "<value>",
  });
  if (res.ok) {
    const { value: result } = res;
...
async function run() {
  const result = await pago.customFields.update({
    id: "<value>",
    customFieldUpdate: {
      type: "date",
    },
...
```typescript
import { PagoCore } from "@pago-sh/sdk/core.js";
import { customFieldsUpdate } from "@pago-sh/sdk/funcs/customFieldsUpdate.js";
...
async function run() {
  const res = await customFieldsUpdate(pago, {
    id: "<value>",
    customFieldUpdate: {
      type: "date",
    },
