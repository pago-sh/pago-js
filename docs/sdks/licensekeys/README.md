...
async function run() {
  const result = await pago.licenseKeys.list({
...
import { licenseKeysList } from "@pago-sh/sdk/funcs/licenseKeysList.js";
...
async function run() {
  const res = await licenseKeysList(pago, {
    organizationId: "1dbfc517-0bbf-4301-9ba8-555ca42b9737",
  });
  if (res.ok) {
...
async function run() {
  const result = await pago.licenseKeys.get({
    id: "<value>",
  });
...
```typescript
import { PagoCore } from "@pago-sh/sdk/core.js";
import { licenseKeysGet } from "@pago-sh/sdk/funcs/licenseKeysGet.js";
...
async function run() {
  const res = await licenseKeysGet(pago, {
    id: "<value>",
  });
  if (res.ok) {
    const { value: result } = res;
...
async function run() {
  const result = await pago.licenseKeys.update({
    id: "<value>",
    licenseKeyUpdate: {},
  });
...
```typescript
import { PagoCore } from "@pago-sh/sdk/core.js";
import { licenseKeysUpdate } from "@pago-sh/sdk/funcs/licenseKeysUpdate.js";
...
async function run() {
  const res = await licenseKeysUpdate(pago, {
    id: "<value>",
    licenseKeyUpdate: {},
  });
  if (res.ok) {
...
async function run() {
  const result = await pago.licenseKeys.getActivation({
    id: "<value>",
    activationId: "<value>",
  });
...
```typescript
import { PagoCore } from "@pago-sh/sdk/core.js";
import { licenseKeysGetActivation } from "@pago-sh/sdk/funcs/licenseKeysGetActivation.js";
...
async function run() {
  const res = await licenseKeysGetActivation(pago, {
    id: "<value>",
    activationId: "<value>",
  });
  if (res.ok) {
...
async function run() {
  const result = await pago.licenseKeys.validate({
    key: "<key>",
...
```typescript
import { PagoCore } from "@pago-sh/sdk/core.js";
import { licenseKeysValidate } from "@pago-sh/sdk/funcs/licenseKeysValidate.js";
...
async function run() {
  const res = await licenseKeysValidate(pago, {
    key: "<key>",
    organizationId: "<value>",
  });
  if (res.ok) {
...
async function run() {
  const result = await pago.licenseKeys.activate({
    key: "<key>",
    organizationId: "<value>",
    label: "<value>",
  });
...
```typescript
import { PagoCore } from "@pago-sh/sdk/core.js";
import { licenseKeysActivate } from "@pago-sh/sdk/funcs/licenseKeysActivate.js";
...
async function run() {
  const res = await licenseKeysActivate(pago, {
    key: "<key>",
    organizationId: "<value>",
    label: "<value>",
  });
...
async function run() {
  await pago.licenseKeys.deactivate({
    key: "<key>",
    organizationId: "<value>",
    activationId: "<value>",
  });
...
```typescript
import { PagoCore } from "@pago-sh/sdk/core.js";
import { licenseKeysDeactivate } from "@pago-sh/sdk/funcs/licenseKeysDeactivate.js";
...
async function run() {
  const res = await licenseKeysDeactivate(pago, {
    key: "<key>",
    organizationId: "<value>",
    activationId: "<value>",
  });
