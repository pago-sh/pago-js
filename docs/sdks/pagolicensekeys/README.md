...
async function run() {
  const result = await pago.customerPortal.licenseKeys.list({
...
import { customerPortalLicenseKeysList } from "@pago-sh/sdk/funcs/customerPortalLicenseKeysList.js";
...
async function run() {
  const res = await customerPortalLicenseKeysList(pago, {
    customerSession: process.env["PAGO_CUSTOMER_SESSION"] ?? "",
  }, {});
  if (res.ok) {
...
async function run() {
  const result = await pago.customerPortal.licenseKeys.get({
    customerSession: process.env["PAGO_CUSTOMER_SESSION"] ?? "",
  }, {
    id: "<value>",
  });
...
```typescript
import { PagoCore } from "@pago-sh/sdk/core.js";
import { customerPortalLicenseKeysGet } from "@pago-sh/sdk/funcs/customerPortalLicenseKeysGet.js";
...
async function run() {
  const res = await customerPortalLicenseKeysGet(pago, {
    customerSession: process.env["PAGO_CUSTOMER_SESSION"] ?? "",
  }, {
    id: "<value>",
  });
...
async function run() {
  const result = await pago.customerPortal.licenseKeys.validate({
    key: "<key>",
...
```typescript
import { PagoCore } from "@pago-sh/sdk/core.js";
import { customerPortalLicenseKeysValidate } from "@pago-sh/sdk/funcs/customerPortalLicenseKeysValidate.js";
...
async function run() {
  const res = await customerPortalLicenseKeysValidate(pago, {
    key: "<key>",
    organizationId: "<value>",
  });
  if (res.ok) {
...
async function run() {
  const result = await pago.customerPortal.licenseKeys.activate({
    key: "<key>",
    organizationId: "<value>",
    label: "<value>",
  });
...
```typescript
import { PagoCore } from "@pago-sh/sdk/core.js";
import { customerPortalLicenseKeysActivate } from "@pago-sh/sdk/funcs/customerPortalLicenseKeysActivate.js";
...
async function run() {
  const res = await customerPortalLicenseKeysActivate(pago, {
    key: "<key>",
    organizationId: "<value>",
    label: "<value>",
  });
...
async function run() {
  await pago.customerPortal.licenseKeys.deactivate({
    key: "<key>",
    organizationId: "<value>",
    activationId: "<value>",
  });
...
```typescript
import { PagoCore } from "@pago-sh/sdk/core.js";
import { customerPortalLicenseKeysDeactivate } from "@pago-sh/sdk/funcs/customerPortalLicenseKeysDeactivate.js";
...
async function run() {
  const res = await customerPortalLicenseKeysDeactivate(pago, {
    key: "<key>",
    organizationId: "<value>",
    activationId: "<value>",
  });
