...
async function run() {
  const result = await pago.subscriptions.list({
...
import { subscriptionsList } from "@pago-sh/sdk/funcs/subscriptionsList.js";
...
async function run() {
  const res = await subscriptionsList(pago, {
    organizationId: "1dbfc517-0bbf-4301-9ba8-555ca42b9737",
  });
  if (res.ok) {
...
async function run() {
  const result = await pago.subscriptions.create({
...
```typescript
import { PagoCore } from "@pago-sh/sdk/core.js";
import { subscriptionsCreate } from "@pago-sh/sdk/funcs/subscriptionsCreate.js";
...
async function run() {
  const res = await subscriptionsCreate(pago, {
    productId: "d8dd2de1-21b7-4a41-8bc3-ce909c0cfe23",
    customerId: "992fae2a-2a17-4b7a-8d9e-e287cf90131b",
  });
  if (res.ok) {
...
async function run() {
  const result = await pago.subscriptions.export({
    organizationId: "1dbfc517-0bbf-4301-9ba8-555ca42b9737",
  });
...
```typescript
import { PagoCore } from "@pago-sh/sdk/core.js";
import { subscriptionsExport } from "@pago-sh/sdk/funcs/subscriptionsExport.js";
...
async function run() {
  const res = await subscriptionsExport(pago, {
    organizationId: "1dbfc517-0bbf-4301-9ba8-555ca42b9737",
  });
  if (res.ok) {
    const { value: result } = res;
...
async function run() {
  const result = await pago.subscriptions.get({
    id: "<value>",
  });
...
```typescript
import { PagoCore } from "@pago-sh/sdk/core.js";
import { subscriptionsGet } from "@pago-sh/sdk/funcs/subscriptionsGet.js";
...
async function run() {
  const res = await subscriptionsGet(pago, {
    id: "<value>",
  });
  if (res.ok) {
    const { value: result } = res;
...
async function run() {
  const result = await pago.subscriptions.revoke({
    id: "<value>",
  });
...
```typescript
import { PagoCore } from "@pago-sh/sdk/core.js";
import { subscriptionsRevoke } from "@pago-sh/sdk/funcs/subscriptionsRevoke.js";
...
async function run() {
  const res = await subscriptionsRevoke(pago, {
    id: "<value>",
  });
  if (res.ok) {
    const { value: result } = res;
...
async function run() {
  const result = await pago.subscriptions.update({
    id: "<value>",
    subscriptionUpdate: {
      productId: "<value>",
    },
...
```typescript
import { PagoCore } from "@pago-sh/sdk/core.js";
import { subscriptionsUpdate } from "@pago-sh/sdk/funcs/subscriptionsUpdate.js";
...
async function run() {
  const res = await subscriptionsUpdate(pago, {
    id: "<value>",
    subscriptionUpdate: {
      productId: "<value>",
    },
