...
async function run() {
  const result = await pago.customerPortal.subscriptions.list({
...
import { customerPortalSubscriptionsList } from "@pago-sh/sdk/funcs/customerPortalSubscriptionsList.js";
...
async function run() {
  const res = await customerPortalSubscriptionsList(pago, {
    customerSession: process.env["PAGO_CUSTOMER_SESSION"] ?? "",
  }, {});
  if (res.ok) {
...
async function run() {
  const result = await pago.customerPortal.subscriptions.get({
    customerSession: process.env["PAGO_CUSTOMER_SESSION"] ?? "",
  }, {
    id: "<value>",
  });
...
```typescript
import { PagoCore } from "@pago-sh/sdk/core.js";
import { customerPortalSubscriptionsGet } from "@pago-sh/sdk/funcs/customerPortalSubscriptionsGet.js";
...
async function run() {
  const res = await customerPortalSubscriptionsGet(pago, {
    customerSession: process.env["PAGO_CUSTOMER_SESSION"] ?? "",
  }, {
    id: "<value>",
  });
...
async function run() {
  const result = await pago.customerPortal.subscriptions.cancel({
    customerSession: process.env["PAGO_CUSTOMER_SESSION"] ?? "",
  }, {
    id: "<value>",
  });
...
```typescript
import { PagoCore } from "@pago-sh/sdk/core.js";
import { customerPortalSubscriptionsCancel } from "@pago-sh/sdk/funcs/customerPortalSubscriptionsCancel.js";
...
async function run() {
  const res = await customerPortalSubscriptionsCancel(pago, {
    customerSession: process.env["PAGO_CUSTOMER_SESSION"] ?? "",
  }, {
    id: "<value>",
  });
...
async function run() {
  const result = await pago.customerPortal.subscriptions.update({
    customerSession: process.env["PAGO_CUSTOMER_SESSION"] ?? "",
  }, {
    id: "<value>",
...
```typescript
import { PagoCore } from "@pago-sh/sdk/core.js";
import { customerPortalSubscriptionsUpdate } from "@pago-sh/sdk/funcs/customerPortalSubscriptionsUpdate.js";
...
async function run() {
  const res = await customerPortalSubscriptionsUpdate(pago, {
    customerSession: process.env["PAGO_CUSTOMER_SESSION"] ?? "",
  }, {
    id: "<value>",
    customerSubscriptionUpdate: {},
