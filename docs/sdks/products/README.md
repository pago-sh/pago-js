...
async function run() {
  const result = await pago.products.list({
...
import { productsList } from "@pago-sh/sdk/funcs/productsList.js";
...
async function run() {
  const res = await productsList(pago, {
    organizationId: "1dbfc517-0bbf-4301-9ba8-555ca42b9737",
  });
  if (res.ok) {
...
async function run() {
  const result = await pago.products.create({
    name: "<value>",
    prices: [
      {
        amountType: "fixed",
...
```typescript
import { PagoCore } from "@pago-sh/sdk/core.js";
import { productsCreate } from "@pago-sh/sdk/funcs/productsCreate.js";
...
async function run() {
  const res = await productsCreate(pago, {
    name: "<value>",
    prices: [
      {
        amountType: "fixed",
...
async function run() {
  const result = await pago.products.get({
    id: "<value>",
  });
...
```typescript
import { PagoCore } from "@pago-sh/sdk/core.js";
import { productsGet } from "@pago-sh/sdk/funcs/productsGet.js";
...
async function run() {
  const res = await productsGet(pago, {
    id: "<value>",
  });
  if (res.ok) {
    const { value: result } = res;
...
async function run() {
  const result = await pago.products.update({
    id: "<value>",
    productUpdate: {},
  });
...
```typescript
import { PagoCore } from "@pago-sh/sdk/core.js";
import { productsUpdate } from "@pago-sh/sdk/funcs/productsUpdate.js";
...
async function run() {
  const res = await productsUpdate(pago, {
    id: "<value>",
    productUpdate: {},
  });
  if (res.ok) {
...
async function run() {
  const result = await pago.products.updateBenefits({
    id: "<value>",
...
```typescript
import { PagoCore } from "@pago-sh/sdk/core.js";
import { productsUpdateBenefits } from "@pago-sh/sdk/funcs/productsUpdateBenefits.js";
...
async function run() {
  const res = await productsUpdateBenefits(pago, {
    id: "<value>",
    productBenefitsUpdate: {
      benefits: [
        "<value 1>",
