...
async function run() {
  const result = await pago.files.list({
...
import { filesList } from "@pago-sh/sdk/funcs/filesList.js";
...
async function run() {
  const res = await filesList(pago, {
    organizationId: "1dbfc517-0bbf-4301-9ba8-555ca42b9737",
  });
  if (res.ok) {
...
async function run() {
  const result = await pago.files.create({
    organizationId: "1dbfc517-0bbf-4301-9ba8-555ca42b9737",
    name: "<value>",
    mimeType: "<value>",
    size: 612128,
...
```typescript
import { PagoCore } from "@pago-sh/sdk/core.js";
import { filesCreate } from "@pago-sh/sdk/funcs/filesCreate.js";
...
async function run() {
  const res = await filesCreate(pago, {
    organizationId: "1dbfc517-0bbf-4301-9ba8-555ca42b9737",
    name: "<value>",
    mimeType: "<value>",
    size: 612128,
...
async function run() {
  const result = await pago.files.uploaded({
    id: "<value>",
    fileUploadCompleted: {
      id: "<id>",
      path: "/boot",
...
```typescript
import { PagoCore } from "@pago-sh/sdk/core.js";
import { filesUploaded } from "@pago-sh/sdk/funcs/filesUploaded.js";
...
async function run() {
  const res = await filesUploaded(pago, {
    id: "<value>",
    fileUploadCompleted: {
      id: "<id>",
      path: "/boot",
...
```typescript
import { PagoCore } from "@pago-sh/sdk/core.js";
import { filesDelete } from "@pago-sh/sdk/funcs/filesDelete.js";
...
async function run() {
  const res = await filesDelete(pago, {
    id: "<value>",
  });
  if (res.ok) {
    const { value: result } = res;
...
async function run() {
  const result = await pago.files.update({
    id: "<value>",
    filePatch: {},
  });
...
```typescript
import { PagoCore } from "@pago-sh/sdk/core.js";
import { filesUpdate } from "@pago-sh/sdk/funcs/filesUpdate.js";
...
async function run() {
  const res = await filesUpdate(pago, {
    id: "<value>",
    filePatch: {},
  });
  if (res.ok) {
