...
async function run() {
  const result = await pago.customerPortal.members.listMembers({});
...
import { customerPortalMembersListMembers } from "@pago-sh/sdk/funcs/customerPortalMembersListMembers.js";
...
async function run() {
  const res = await customerPortalMembersListMembers(pago, {});
  if (res.ok) {
...
async function run() {
  const result = await pago.customerPortal.members.addMember({
...
```typescript
import { PagoCore } from "@pago-sh/sdk/core.js";
import { customerPortalMembersAddMember } from "@pago-sh/sdk/funcs/customerPortalMembersAddMember.js";
...
async function run() {
  const res = await customerPortalMembersAddMember(pago, {
    email: "Domenica.Schamberger@yahoo.com",
  });
  if (res.ok) {
    const { value: result } = res;
...
async function run() {
  await pago.customerPortal.members.removeMember({
...
```typescript
import { PagoCore } from "@pago-sh/sdk/core.js";
import { customerPortalMembersRemoveMember } from "@pago-sh/sdk/funcs/customerPortalMembersRemoveMember.js";
...
async function run() {
  const res = await customerPortalMembersRemoveMember(pago, {
    id: "b61c5e87-cda5-4b14-93ee-71a695f42d9d",
  });
  if (res.ok) {
    const { value: result } = res;
...
async function run() {
  const result = await pago.customerPortal.members.updateMember({
...
```typescript
import { PagoCore } from "@pago-sh/sdk/core.js";
import { customerPortalMembersUpdateMember } from "@pago-sh/sdk/funcs/customerPortalMembersUpdateMember.js";
...
async function run() {
  const res = await customerPortalMembersUpdateMember(pago, {
    id: "8319ae11-ed5f-4642-81e4-4b40731df195",
    customerPortalMemberUpdate: {},
  });
  if (res.ok) {
