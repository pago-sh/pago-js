...
Developer-friendly & type-safe Typescript SDK specifically catered to leverage [Pago](https://pago.sh) API.

<div align="left">
    <a href="https://www.speakeasy.com/?utm_source=@pago-sh/sdk&utm_campaign=typescript"><img src="https://custom-icon-badges.demolab.com/badge/-Built%20By%20Speakeasy-212015?style=for-the-badge&logoColor=FBE331&logo=speakeasy&labelColor=545454" /></a>
...
import { validateEvent, WebhookVerificationError } from "@pago-sh/sdk/webhooks";

const app = express();

app.post("/webhook", express.raw({ type: "application/json" }), (req: Request, res: Response) => {
  try {
    const event = validateEvent(req.body, req.headers, process.env["PAGO_WEBHOOK_SECRET"] ?? "");
...
* [requestEmailUpdate](docs/sdks/pagocustomers/README.md#requestemailupdate) - Request Email Change
* [checkEmailUpdate](docs/sdks/pagocustomers/README.md#checkemailupdate) - Check Email Change Token
* [verifyEmailUpdate](docs/sdks/pagocustomers/README.md#verifyemailupdate) - Verify Email Change
...
* [receipt](docs/sdks/pagoorders/README.md#receipt) - Get Order Receipt
...
- [`customerPortalBenefitGrantsGet`](docs/sdks/pagobenefitgrants/README.md#get) - Get Benefit Grant
- [`customerPortalBenefitGrantsList`](docs/sdks/pagobenefitgrants/README.md#list) - List Benefit Grants
- [`customerPortalBenefitGrantsUpdate`](docs/sdks/pagobenefitgrants/README.md#update) - Update Benefit Grant
- [`customerPortalCustomerMetersGet`](docs/sdks/pagocustomermeters/README.md#get) - Get Customer Meter
- [`customerPortalCustomerMetersList`](docs/sdks/pagocustomermeters/README.md#list) - List Meters
- [`customerPortalCustomersAddPaymentMethod`](docs/sdks/pagocustomers/README.md#addpaymentmethod) - Add Customer Payment Method
- [`customerPortalCustomersCheckEmailUpdate`](docs/sdks/pagocustomers/README.md#checkemailupdate) - Check Email Change Token
- [`customerPortalCustomersConfirmPaymentMethod`](docs/sdks/pagocustomers/README.md#confirmpaymentmethod) - Confirm Customer Payment Method
- [`customerPortalCustomersDeletePaymentMethod`](docs/sdks/pagocustomers/README.md#deletepaymentmethod) - Delete Customer Payment Method
...
- [`customerPortalCustomersGet`](docs/sdks/pagocustomers/README.md#get) - Get Customer
- [`customerPortalCustomersListPaymentMethods`](docs/sdks/pagocustomers/README.md#listpaymentmethods) - List Customer Payment Methods
- [`customerPortalCustomersRequestEmailUpdate`](docs/sdks/pagocustomers/README.md#requestemailupdate) - Request Email Change
- [`customerPortalCustomersUpdate`](docs/sdks/pagocustomers/README.md#update) - Update Customer
- [`customerPortalCustomersVerifyEmailUpdate`](docs/sdks/pagocustomers/README.md#verifyemailupdate) - Verify Email Change
- [`customerPortalDownloadablesList`](docs/sdks/downloadables/README.md#list) - List Downloadables
- [`customerPortalLicenseKeysActivate`](docs/sdks/pagolicensekeys/README.md#activate) - Activate License Key
- [`customerPortalLicenseKeysDeactivate`](docs/sdks/pagolicensekeys/README.md#deactivate) - Deactivate License Key
- [`customerPortalLicenseKeysGet`](docs/sdks/pagolicensekeys/README.md#get) - Get License Key
- [`customerPortalLicenseKeysList`](docs/sdks/pagolicensekeys/README.md#list) - List License Keys
- [`customerPortalLicenseKeysValidate`](docs/sdks/pagolicensekeys/README.md#validate) - Validate License Key
- [`customerPortalMembersAddMember`](docs/sdks/pagomembers/README.md#addmember) - Add Member
- [`customerPortalMembersListMembers`](docs/sdks/pagomembers/README.md#listmembers) - List Members
- [`customerPortalMembersRemoveMember`](docs/sdks/pagomembers/README.md#removemember) - Remove Member
- [`customerPortalMembersUpdateMember`](docs/sdks/pagomembers/README.md#updatemember) - Update Member
- [`customerPortalOrdersConfirmRetryPayment`](docs/sdks/pagoorders/README.md#confirmretrypayment) - Confirm Retry Payment
- [`customerPortalOrdersGenerateInvoice`](docs/sdks/pagoorders/README.md#generateinvoice) - Generate Order Invoice
- [`customerPortalOrdersGet`](docs/sdks/pagoorders/README.md#get) - Get Order
- [`customerPortalOrdersGetPaymentStatus`](docs/sdks/pagoorders/README.md#getpaymentstatus) - Get Order Payment Status
- [`customerPortalOrdersInvoice`](docs/sdks/pagoorders/README.md#invoice) - Get Order Invoice
- [`customerPortalOrdersList`](docs/sdks/pagoorders/README.md#list) - List Orders
- [`customerPortalOrdersReceipt`](docs/sdks/pagoorders/README.md#receipt) - Get Order Receipt
- [`customerPortalOrdersUpdate`](docs/sdks/pagoorders/README.md#update) - Update Order
- [`customerPortalOrganizationsGet`](docs/sdks/pagoorganizations/README.md#get) - Get Organization
...
- [`customerPortalSubscriptionsCancel`](docs/sdks/pagosubscriptions/README.md#cancel) - Cancel Subscription
- [`customerPortalSubscriptionsGet`](docs/sdks/pagosubscriptions/README.md#get) - Get Subscription
- [`customerPortalSubscriptionsList`](docs/sdks/pagosubscriptions/README.md#list) - List Subscriptions
- [`customerPortalSubscriptionsUpdate`](docs/sdks/pagosubscriptions/README.md#update) - Update Subscription
...
[`PagoError`](./src/models/errors/pagoerror.ts) is the base class for all HTTP error responses. It has the following properties:
...
```typescript
import { Pago } from "@pago-sh/sdk";
import { HTTPValidationError } from "@pago-sh/sdk/models/errors/httpvalidationerror.js";
import { PagoError } from "@pago-sh/sdk/models/errors/pagoerror.js.js";
...
### Error Classes
**Primary errors:**
* [`PagoError`](./src/models/errors/pagoerror.ts): The base class for HTTP error responses.
...
**Inherit from [`PagoError`](./src/models/errors/pagoerror.ts)**:
...
import { HTTPClient } from "@pago-sh/sdk/lib/http";
...
const sdk = new Pago({ httpClient: httpClient });
```
...
async function run() {
  const result = await pago.customerPortal.benefitGrants.list({}, {});
...
const sdk = new Pago({ debugLogger: console });
```

You can also enable a default debug logger by setting an environment variable `PAGO_DEBUG` to true.
<!-- End Debugging [debug] -->
...
### SDK Created by [Speakeasy](https://www.speakeasy.com/?utm_source=@pago-sh/sdk&utm_campaign=typescript)
