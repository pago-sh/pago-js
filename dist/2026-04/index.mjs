...
import { a as validateWebhook, i as PagoWebhookVerificationError, o as ClientBase, r as PagoWebhookUnknownTypeError, s as PagoClientError, t as PagoWebhookError } from "../webhooks-Brk6wjWp.mjs";
...
* Validation Error
*/
var HTTPValidationError = class extends PagoClientError {
	statusCode;
	error;
...
* Forbidden
*/
var CannotCreateOrganizationError = class extends PagoClientError {
	statusCode;
	error;
	constructor(statusCode, error) {
		super(statusCode, error);
...
*/
var ResourceNotFound = class extends PagoClientError {
	statusCode;
	error;
	constructor(statusCode, error) {
		super(statusCode, error);
...
*/
var NotPermitted = class extends PagoClientError {
	statusCode;
	error;
	constructor(statusCode, error) {
		super(statusCode, error);
...
*/
var SSOEnforcementRequiresConnection = class extends PagoClientError {
	statusCode;
	error;
	constructor(statusCode, error) {
		super(statusCode, error);
...
*/
var AlreadyCanceledSubscription = class extends PagoClientError {
	statusCode;
	error;
	constructor(statusCode, error) {
		super(statusCode, error);
...
*/
var SubscriptionLocked = class extends PagoClientError {
	statusCode;
	error;
	constructor(statusCode, error) {
		super(statusCode, error);
...
*/
var PaymentFailed = class extends PagoClientError {
	statusCode;
	error;
	constructor(statusCode, error) {
		super(statusCode, error);
...
*/
var Finalize402Error = class extends PagoClientError {
	statusCode;
	error;
	constructor(statusCode, error) {
		super(statusCode, error);
...
*/
var Finalize403Error = class extends PagoClientError {
	statusCode;
	error;
	constructor(statusCode, error) {
		super(statusCode, error);
...
*/
var OrderNotDraft = class extends PagoClientError {
	statusCode;
	error;
	constructor(statusCode, error) {
		super(statusCode, error);
...
*/
var OrderNotEligibleForInvoice = class extends PagoClientError {
	statusCode;
	error;
	constructor(statusCode, error) {
		super(statusCode, error);
...
*/
var MissingInvoiceBillingDetails = class extends PagoClientError {
	statusCode;
	error;
	constructor(statusCode, error) {
		super(statusCode, error);
...
*/
var RefundedAlready = class extends PagoClientError {
	statusCode;
	error;
	constructor(statusCode, error) {
		super(statusCode, error);
...
* Conflict
*/
var DisputeNotOpenError = class extends PagoClientError {
	statusCode;
	error;
	constructor(statusCode, error) {
		super(statusCode, error);
...
*/
var Update403Error = class extends PagoClientError {
	statusCode;
	error;
	constructor(statusCode, error) {
		super(statusCode, error);
...
*/
var ExpiredCheckoutError = class extends PagoClientError {
	statusCode;
	error;
	constructor(statusCode, error) {
		super(statusCode, error);
...
* The checkout is expired, the customer already has an active subscription, or the organization is not ready to accept payments.
*/
var ClientUpdate403Error = class extends PagoClientError {
	statusCode;
	error;
	constructor(statusCode, error) {
		super(statusCode, error);
...
* The payment failed.
*/
var PaymentError = class extends PagoClientError {
	statusCode;
	error;
	constructor(statusCode, error) {
		super(statusCode, error);
...
* The checkout is expired, the customer already has an active subscription, or the organization is not ready to accept payments.
*/
var ClientConfirm403Error = class extends PagoClientError {
	statusCode;
	error;
	constructor(statusCode, error) {
		super(statusCode, error);
...
*/
var Unauthorized = class extends PagoClientError {
	statusCode;
	error;
	constructor(statusCode, error) {
		super(statusCode, error);
...
*/
var AmbiguousExternalCustomerID = class extends PagoClientError {
	statusCode;
	error;
	constructor(statusCode, error) {
		super(statusCode, error);
...
*/
var PaymentMethodSetupFailed = class extends PagoClientError {
	statusCode;
	error;
	constructor(statusCode, error) {
		super(statusCode, error);
...
*/
var CustomerNotReady = class extends PagoClientError {
	statusCode;
	error;
	constructor(statusCode, error) {
		super(statusCode, error);
...
*/
var PaymentMethodInUseByActiveSubscription = class extends PagoClientError {
	statusCode;
	error;
	constructor(statusCode, error) {
		super(statusCode, error);
...
*/
var CheckEmailUpdate401Error = class extends PagoClientError {
	statusCode;
	error;
	constructor(statusCode, error) {
		super(statusCode, error);
...
* Invalid or expired verification token.
*/
var VerifyEmailUpdate401Error = class extends PagoClientError {
	statusCode;
	error;
	constructor(statusCode, error) {
		super(statusCode, error);
...
*/
var VerifyEmailUpdate422Error = class extends PagoClientError {
	statusCode;
	error;
	constructor(statusCode, error) {
		super(statusCode, error);
...
*/
var ListSeats401Error = class extends PagoClientError {
	statusCode;
	error;
	constructor(statusCode, error) {
		super(statusCode, error);
...
*/
var ListSeats403Error = class extends PagoClientError {
	statusCode;
	error;
	constructor(statusCode, error) {
		super(statusCode, error);
...
*/
var ListSeats404Error = class extends PagoClientError {
	statusCode;
	error;
	constructor(statusCode, error) {
		super(statusCode, error);
...
*/
var AssignSeat400Error = class extends PagoClientError {
	statusCode;
	error;
	constructor(statusCode, error) {
		super(statusCode, error);
...
* Authentication required
*/
var AssignSeat401Error = class extends PagoClientError {
	statusCode;
	error;
	constructor(statusCode, error) {
		super(statusCode, error);
...
* Not permitted or seat-based pricing not enabled
*/
var AssignSeat403Error = class extends PagoClientError {
	statusCode;
	error;
	constructor(statusCode, error) {
		super(statusCode, error);
...
*/
var AssignSeat404Error = class extends PagoClientError {
	statusCode;
	error;
	constructor(statusCode, error) {
		super(statusCode, error);
...
* Authentication required
*/
var RevokeSeat401Error = class extends PagoClientError {
	statusCode;
	error;
	constructor(statusCode, error) {
		super(statusCode, error);
...
* Not permitted or seat-based pricing not enabled
*/
var RevokeSeat403Error = class extends PagoClientError {
	statusCode;
	error;
	constructor(statusCode, error) {
		super(statusCode, error);
...
* Seat not found
*/
var RevokeSeat404Error = class extends PagoClientError {
	statusCode;
	error;
	constructor(statusCode, error) {
		super(statusCode, error);
...
*/
var ResendInvitation400Error = class extends PagoClientError {
	statusCode;
	error;
	constructor(statusCode, error) {
		super(statusCode, error);
...
* Authentication required
*/
var ResendInvitation401Error = class extends PagoClientError {
	statusCode;
	error;
	constructor(statusCode, error) {
		super(statusCode, error);
...
* Not permitted or seat-based pricing not enabled
*/
var ResendInvitation403Error = class extends PagoClientError {
	statusCode;
	error;
	constructor(statusCode, error) {
		super(statusCode, error);
...
* Seat not found
*/
var ResendInvitation404Error = class extends PagoClientError {
	statusCode;
	error;
	constructor(statusCode, error) {
		super(statusCode, error);
...
* Authentication required
*/
var ListClaimedSubscriptions401Error = class extends PagoClientError {
	statusCode;
	error;
	constructor(statusCode, error) {
		super(statusCode, error);
...
* Authentication required
*/
var ListMembers401Error = class extends PagoClientError {
	statusCode;
	error;
	constructor(statusCode, error) {
		super(statusCode, error);
...
*/
var ListMembers403Error = class extends PagoClientError {
	statusCode;
	error;
	constructor(statusCode, error) {
		super(statusCode, error);
...
*/
var AddMember400Error = class extends PagoClientError {
	statusCode;
	error;
	constructor(statusCode, error) {
		super(statusCode, error);
...
* Authentication required
*/
var AddMember401Error = class extends PagoClientError {
	statusCode;
	error;
	constructor(statusCode, error) {
		super(statusCode, error);
...
* Not permitted - requires owner or billing manager role
*/
var AddMember403Error = class extends PagoClientError {
	statusCode;
	error;
	constructor(statusCode, error) {
		super(statusCode, error);
...
*/
var RemoveMember400Error = class extends PagoClientError {
	statusCode;
	error;
	constructor(statusCode, error) {
		super(statusCode, error);
...
* Authentication required
*/
var RemoveMember401Error = class extends PagoClientError {
	statusCode;
	error;
	constructor(statusCode, error) {
		super(statusCode, error);
...
* Not permitted - requires owner or billing manager role
*/
var RemoveMember403Error = class extends PagoClientError {
	statusCode;
	error;
	constructor(statusCode, error) {
		super(statusCode, error);
...
* Member not found.
*/
var RemoveMember404Error = class extends PagoClientError {
	statusCode;
	error;
	constructor(statusCode, error) {
		super(statusCode, error);
...
* Invalid role change.
*/
var UpdateMember400Error = class extends PagoClientError {
	statusCode;
	error;
	constructor(statusCode, error) {
		super(statusCode, error);
...
* Authentication required
*/
var UpdateMember401Error = class extends PagoClientError {
	statusCode;
	error;
	constructor(statusCode, error) {
		super(statusCode, error);
...
* Not permitted - requires owner or billing manager role
*/
var UpdateMember403Error = class extends PagoClientError {
	statusCode;
	error;
	constructor(statusCode, error) {
		super(statusCode, error);
...
* Member not found.
*/
var UpdateMember404Error = class extends PagoClientError {
	statusCode;
	error;
	constructor(statusCode, error) {
		super(statusCode, error);
...
*/
var PaymentAlreadyInProgress = class extends PagoClientError {
	statusCode;
	error;
	constructor(statusCode, error) {
		super(statusCode, error);
...
*/
var OrderNotEligibleForRetry = class extends PagoClientError {
	statusCode;
	error;
	constructor(statusCode, error) {
		super(statusCode, error);
...
*/
var ManualRetryLimitExceeded = class extends PagoClientError {
	statusCode;
	error;
	constructor(statusCode, error) {
		super(statusCode, error);
...
*/
var GetClaimInfo400Error = class extends PagoClientError {
	statusCode;
	error;
	constructor(statusCode, error) {
		super(statusCode, error);
...
*/
var GetClaimInfo403Error = class extends PagoClientError {
	statusCode;
	error;
	constructor(statusCode, error) {
		super(statusCode, error);
...
* Seat not found
*/
var GetClaimInfo404Error = class extends PagoClientError {
	statusCode;
	error;
	constructor(statusCode, error) {
		super(statusCode, error);
...
*/
var ClaimSeat400Error = class extends PagoClientError {
	statusCode;
	error;
	constructor(statusCode, error) {
		super(statusCode, error);
...
* Seat-based pricing not enabled for organization
*/
var ClaimSeat403Error = class extends PagoClientError {
	statusCode;
	error;
	constructor(statusCode, error) {
		super(statusCode, error);
...
* Not Found
*/
var Update404Error = class extends PagoClientError {
	statusCode;
	error;
	constructor(statusCode, error) {
		super(statusCode, error);
...
var webhooks_exports = /* @__PURE__ */ __exportAll({
	PagoWebhookError: () => PagoWebhookError,
	PagoWebhookUnknownTypeError: () => PagoWebhookUnknownTypeError,
	PagoWebhookVerificationError: () => PagoWebhookVerificationError,
...
const validateEvent = (body, headers, secret) => {
	return validateWebhook(body, headers, secret, knownEventTypes);
};
//#endregion
export { createPago, errors_exports as errors, models_exports as models, webhooks_exports as webhooks };
