...
const verifySignature = (body, headers, secret) => {
	...
	const signedContent = node_buffer.Buffer.concat([node_buffer.Buffer.from(`${webhookId}.${webhookTimestamp}.`, "utf8"), node_buffer.Buffer.from(body)]);
	const expectedSignature = (0, node_crypto.createHmac)("sha256", signingKey).update(signedContent).digest();
	let matched = false;
...
const constantTimeEqual = (left, right) => left.length === right.length && (0, node_crypto.timingSafeEqual)(left, right);
const decodeBase64 = (value) => {
	...
	const decoded = node_buffer.Buffer.from(padded, "base64");
	if (decoded.length === 0 || decoded.toString("base64") !== padded) return null;
	return decoded;
};
//#endregion
Object.defineProperty(exports, "ClientBase", {
	enumerable: true,
	get: function() {
		return ClientBase;
	}
});
Object.defineProperty(exports, "PagoClientError", {
	enumerable: true,
	get: function() {
		return PagoClientError;
	}
});
Object.defineProperty(exports, "PagoError", {
	enumerable: true,
	get: function() {
		return PagoError;
	}
});
Object.defineProperty(exports, "PagoNetworkError", {
	enumerable: true,
	get: function() {
		return PagoNetworkError;
	}
});
Object.defineProperty(exports, "PagoRateLimitError", {
	enumerable: true,
	get: function() {
		return PagoRateLimitError;
	}
});
Object.defineProperty(exports, "PagoServerError", {
	enumerable: true,
	get: function() {
		return PagoServerError;
	}
});
Object.defineProperty(exports, "PagoWebhookError", {
	enumerable: true,
	get: function() {
		return PagoWebhookError;
	}
});
Object.defineProperty(exports, "PagoWebhookSecretError", {
	enumerable: true,
	get: function() {
		return PagoWebhookSecretError;
	}
});
Object.defineProperty(exports, "PagoWebhookUnknownTypeError", {
	enumerable: true,
	get: function() {
		return PagoWebhookUnknownTypeError;
	}
});
Object.defineProperty(exports, "PagoWebhookVerificationError", {
	enumerable: true,
	get: function() {
		return PagoWebhookVerificationError;
	}
});
Object.defineProperty(exports, "validateWebhook", {
	enumerable: true,
	get: function() {
...
//# sourceMappingURL=webhooks-CG-bSKxt.cjs.map